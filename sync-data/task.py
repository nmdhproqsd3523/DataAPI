...
def GetVote(hex_str):
    main = "./bigbang %s" % (hex_str[0:66])
    dpos_addr = commands.getstatusoutput(main)[1]

    main = "./bigbang %s" % (hex_str[66:])
    client_addr = commands.getstatusoutput(main)[1]
